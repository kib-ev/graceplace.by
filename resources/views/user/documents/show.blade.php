...
<div id="Document" class="text14">
    ...
    <table class="border" cellpadding="0" cellspacing="0" style="width: 100%;">
        ...
        <tr>
            ...
            <td style="width: 200px;"><b>Наименование</b></td>
            <td style="width: 26px;"><b>Ед. изм.</b></td>
            <td style="width: 26px;"><b>Кол- во</b></td>
            <td style="width: 26px;"><b>Цена, руб. коп.</b></td>
    ...
    <div class="footer">
        ...
        <p>Исполнитель:
            <br>
            <br>
            директор ________________________ Киб Евгений Валентинович</p>
