...
return [
    ...
    */
    ...
    | Orientation
    |--------------------------------------------------------------------------
    | Possible values: 'any', 'natural', 'landscape', 'portrait'
    */
    ...
    | Status Bar
    |--------------------------------------------------------------------------
    | Only for iOS. Possible values: 'default', 'black', 'black-translucent'
    */
    'status_bar' => 'black',
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Splash Screens (для iOS PWA)
    |--------------------------------------------------------------------------
    | Указываются пути к изображениям, подходящим по разрешению.
    */
    'splash' => [
